...
<span class="topBarElem" style="padding-right:70px">
	<span id="languageSelection" style="position:absolute">
		...
		<select name="language" id="language">
			<option value="" href="?module=Proxy&amp;action=redirect&amp;url=http://piwik.org/translations/"><?php echo ((is_array($_tmp='LanguagesManager_AboutPiwikTranslations')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</option>
