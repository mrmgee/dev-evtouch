...
" src="themes/default/images/image.png" /></a>
        ...
        <div class="limitSelection <?php if (! $this->_tpl_vars['properties']['show_pagination_control']): ?> hidden<?php endif; ?>" title="<?php echo ((is_array($_tmp='General_RowsToDisplay')) ? $this->_run_mod_handler('translate', true, $_tmp, 'escape', 'html') : smarty_modifier_translate($_tmp, 'escape', 'html')); ?>
"></div>
...
<div class="datatableRelatedReports">
	<?php if (! empty ( $this->_tpl_vars['properties']['relatedReports'] ) && ( ! empty ( $this->_tpl_vars['arrayDataTable'] ) || ! empty ( $this->_tpl_vars['cloudValues'] ) || ( isset ( $this->_tpl_vars['isDataAvailable'] ) && $this->_tpl_vars['isDataAvailable'] ) )): ?>
