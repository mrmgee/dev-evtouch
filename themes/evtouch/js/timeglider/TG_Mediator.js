	       	...
	       	if ( i === 0 ) {
				...
				children.each(function(i){
					...
					if (field == "description"){
						value = $(this).html();	//Orig
//						value = '<div class="myDiv">'+$(this).html()+'</div>';	//MG works - places div avound in js code created
//						value = $(this).text();	//MG strips out html tags
					} else {	//Orig
/*
					} else if (field == "title"){	//MG exception for milestone titles
						value = $(this).html();
					} else {
*/					
						value = $(this).text();
...
//    	basic_fontsize:{type:"number", min:9, max:100}, //Orig
    	basic_fontsize:{type:"number", min:9, max:20},
