...
//								img_style = 'class="aboveImgHere'+i+'"';	//MG Testing
								...
								imgLastStr = imgSrcStr.substr(-6); // removes last 6 chars(../img/img09-1.png) returns -1.png
								imgPrimary = imgLastStr.substr(0,2); // return first 2 chars(-1.png) returns -1
								
								if (imgPrimary == "-1") {	// img file is primary
									img_style = "";
								} else {
