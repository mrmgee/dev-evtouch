    ...
    */
    this.getHTML = function (tickScope, ceiling) {
		...
		for (var i=0; i<blength; i++) {
			...
			img_scale = 100;
			img_style = "";
			b.right	= b.right+80;	//MG add 80px to right to make width accomodate icon
...
//								img_style = ""; //Orig
//								img_style = 'class="aboveImgHere'+i+'"';	//MG Testing
								imgSrcStr = b.image.src;	//MG returns /themes/evtouch/js/timeglider/img/img09-1.png
								imgLastStr = imgSrcStr.substr(-6); // removes last 6 chars(../img/img09-2.png) returns -1.png
								imgPrimary = imgLastStr.substr(0,2); // return first 2 chars(-2.png) returns -2
								
								if (imgPrimary == "-2") {	// img file is primary
									img_style = 'class="aboveImgSec"';
								} else {
									img_style = "";
								}
								
					//01 <img src="/themes/evtouch/js/timeglider/img/img02.png" class="aboveImgSec 02.png | .png">			
					//02 <img src="/themes/evtouch/js/timeglider/img/img09-1.png" class="aboveImgSec -1.png | .png">
					//03 <img src="/themes/evtouch/js/timeglider/img/img09-1.png" primary="">
							}
...
//							+ b.title + //MG added title to image timeglider-event-image-above
							img = "<div class='timeglider-event-image-" + b.image.display_class + "'><img src='" + b.image.src + "' " + img_style + " ondragstart='return false'></div>";							
//							img = "<div class='timeglider-event-image-" + b.image.display_class + "'><img src='" + b.image.src + "' " + img_style + "><p>"+b[i]+"</p></div>";
...
//						+ b.fontsize + "px;left:-" + (b.fontsize + 2) + "px; top:" + title_adj + "px'>";	//Orig

						  icon = "<img class='timeglider-event-icon' src='" + icon_f + b.icon + "' style='height:"
						+ ((b.fontsize*2)+16) + "px;left:-" + ((b.fontsize*2)+16) + "px; top:" + title_adj + "px'>";	//MG increase icon height max=64px
						// (24 x 2 = 48) + 16 = 64
						} else {
						  icon = '';
						}
						...
						if (ceiling && (me.pol == -1) && (Math.abs(b.top) > (ceiling - ceiling_padding))) {
							...
							html += "<div class='timeglider-timeline-event " 	//SHARE in Nature
								+ b.css_class + " " + span_selector_class 
								+ "' id='" + b.id + "' "
//								+ "style='width:" + b.width  + "px;"	//Orig 526
								+ "style='width:" + (b.width+80)  + "px;"	//Orig (b.width+80)=606 | (b.width+70)=596 icon width | (b.width+20)=546
//								+ "height:" + b.height + "px;"	//Orig	26
								+ "height:" + ((b.height*2)+12) + "px;" 	//MG (26x2=52)+12=64 | 26x2=52 ((b.fontsize*2)+16)
								
								+ "left:" + b.left  + "px;" 
								+ "right:" + b.right  + "px;" //MG 1475 after +80 b.right above	| 1395.18
								+ "opacity:" + b.opacity + ";"
//								+ "top:" + (b.top + south_padding) + "px;"	//Orig -48px
								+ "top:" + ((b.top + south_padding)*2) + "px;"	//MG -96px
								+ "font-size:" + b.fontsize  + "px;'>"
								+ icon + img + span_div 
								+ "<div class='timeglider-event-title' style='top:" + title_adj + "px'>" 
								+ b.title
							//	+ ev.startdateObj.format // MG added
								+ "</div></div>";
