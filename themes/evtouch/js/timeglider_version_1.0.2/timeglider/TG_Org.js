						...
						if (b.html && b.html.substr(0,4) == "<div") {
							...
							if (polarity_cond){
								...
								if (b.fontsize > 2) {
									...
									if (b.icon) {
									  icon = "<img class='timeglider-event-icon' src='" + icon_f + b.icon + "' style='height:" + Math.round(((b.fontsize*2)+2)) + "px;left:-" + Math.round(((b.fontsize*2)+2)) + "px; top:" + title_adj + "px'>";
									} else {
									  icon = '';
									}
