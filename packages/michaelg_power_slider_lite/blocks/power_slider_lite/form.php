...
<style>
	...
	.collapseContainer {  }
		...
		.collapseContainer h2 { padding: 4px 0 4px 25px; border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; cursor: pointer; background: url(<?php  echo $this->getBlockURL(); ?>/img/bgSectionTitle.gif) top left no-repeat; }
		.collapseContainer h2.active { background-position: bottom left; }
...
<div class="collapseContainer">
    ...
    <div class="collapsingDiv">
        ...
        <?php  echo $form->text('powerSlideWidth', empty($powerSlideWidth)?$defaultWidth:$powerSlideWidth, array('style' => 'width: 90px')). " px";?>
        </div>
        
        <div style="margin: 20px 0;">
        <label for="powerSlideHeight"><?php  echo t("Yeah, and what kinda height we talkin?"); ?></label>
        <?php  echo $form->text('powerSlideHeight', empty($powerSlideHeight)?$defaultHeight:$powerSlideHeight, array('style' => 'width: 90px')). " px";?>
        </div>
    ...
    <div class="collapsingDiv">
        ...
        <div id="prevNextHiddenFields">
            <div style="margin: 20px 0;">
                ...
                <?php  echo $form->text('prevBtnOffsetY', !isset($prevBtnOffsetY)?$defaultPrevY:$prevBtnOffsetY, array('style' => 'width: 90px')). " px";?>
            </div>
            
            <div style="margin: 20px 0;">
                <label for="prevBtnOffsetX"><?php  echo t("Distance from left you'd like the Previous Arrow"); ?></label>
                <?php  echo $form->text('prevBtnOffsetX', !isset($prevBtnOffsetX)?$defaultPrevX:$prevBtnOffsetX, array('style' => 'width: 90px')). " px";?>
            </div>
            
            <div style="margin: 20px 0;">
                <label for="nextBtnOffsetY"><?php  echo t("Distance from bottom you'd like the Next Arrow"); ?></label>
				<?php  echo $form->text('nextBtnOffsetY', !isset($nextBtnOffsetY)?$defaultNextY:$nextBtnOffsetY, array('style' => 'width: 90px')). " px";?>
            </div>
            
            <div style="margin: 20px 0;">
                <label for="nextBtnOffsetX"><?php  echo t("Distance from right you'd like the Next Arrow"); ?></label>
                <?php  echo $form->text('nextBtnOffsetX', !isset($nextBtnOffsetX)?$defaultNextX:$nextBtnOffsetX, array('style' => 'width: 90px')). " px";?>
            </div>
         </div>
    </div><!-- .collapsingDiv -->
    ...
    <div class="collapsingDiv">
        ...
        <div id="paginationOptionsHidden">
            <div style="margin: 20px 0;">
                ...
                <?php  echo $form->text('paginationOffsetY', !isset($paginationOffsetY)?$defaultPaginationY:$paginationOffsetY, array('style' => 'width: 90px')). " px";?>
                
            </div>
            
            <div style="margin: 20px 0;">
                <label for="paginationAlignment"><?php  echo t("Pagination Alignment"); ?></label>
                <?php  echo $form->select('paginationAlignment', array('left' => 'Left', 'right' => 'Right', 'center' => 'Center'), empty($paginationAlignment)?$defaultPaginationAlignment:$paginationAlignment);?>
            </div>
        </div>
